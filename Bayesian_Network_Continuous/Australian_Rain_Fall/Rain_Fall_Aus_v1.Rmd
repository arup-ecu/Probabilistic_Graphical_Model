...
```{r, include=TRUE}
rain.df <- read.csv("Data/RainFallAus/weatherAUS.csv",nrows = 8000)[ ,c("Location","MinTemp","MaxTemp","Rainfall", "Evaporation", "Sunshine","WindGustDir","WindGustSpeed", "WindDir9am"   
...
rain_rel.df <- read.csv("Data/RainFallAus/weatherAUS.csv",nrows = 5000)[ ,c("MinTemp","MaxTemp", "Evaporation", "Sunshine","Humidity9am","Humidity3pm", "Pressure9am",  "Pressure3pm", "Cloud9am",  "Cloud3pm", "Temp9am","Temp3pm","RainTomorrow" )]
...
```{r, echo=FALSE, message=FALSE, warning=FALSE}
# ggpairs(wines.df, columns = 5:7, ggplot2::aes(color=quality)) 
```
